        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end flex-1">
          ...
          <div className="lg:col-span-7 flex flex-col text-center lg:text-left items-center lg:items-start gap-6 pb-6">
            ...
            >
              ...
              <div className={`flex items-center gap-2.5 p-1.5 rounded-2xl backdrop-blur-md self-center sm:self-auto justify-center transition-colors ${
                theme === "light" 
                  ? "bg-slate-200/80 border border-slate-300 shadow-md" 
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-xl flex items-center justify-center border border-slate-800 bg-[#181717] hover:bg-black hover:scale-110 shadow-md transition-all group"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-xl flex items-center justify-center border border-[#0A66C2] bg-[#0A66C2] hover:bg-[#084e96] hover:scale-110 shadow-md transition-all group"
